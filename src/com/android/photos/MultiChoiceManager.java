...
public class MultiChoiceManager implements MultiChoiceModeListener,
    ...
    public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
        final int actionItemId = item.getItemId();
        if (actionItemId == R.id.menu_delete) {
            ...
            mode.finish();
        } else if (actionItemId == R.id.menu_edit || actionItemId == R.id.menu_crop ||
                actionItemId == R.id.menu_trim || actionItemId == R.id.menu_mute) {
